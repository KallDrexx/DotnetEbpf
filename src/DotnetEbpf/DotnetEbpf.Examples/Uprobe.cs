...
public static class Uprobe
{
    ...
    [CustomDeclaration("int BPF_KPROBE(uprobe_add, int a, int b)", null, "<bpf/bpf_tracing.h>")]
    ...
    [CustomDeclaration("int BPF_KRETPROBE(uretprobe_add, int ret)", null, "<bpf/bpf_tracing.h>")]
    ...
    [CustomDeclaration("int BPF_KPROBE(uprobe_sub, int a, int b)", null, "<bpf/bpf_tracing.h>")]
    ...
    [CustomDeclaration("int BPF_KRETPROBE(uretprobe_sub, int ret)", null, "<bpf/bpf_tracing.h>")]
